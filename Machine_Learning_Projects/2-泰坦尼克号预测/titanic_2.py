...
bad_cases = origin_train_data.loc[origin_train_data['PassengerId'].isin(split_cv[predictions != cv_df.as_matrix()[:,0]]['PassengerId'].values)]
#print(bad_cases)

#学习曲线
from  sklearn.model_selection import learning_curve
def plot_learning_curve(estimator,title,X,y,ylim=None,cv=None,train_sizes=np.linspace(0.05,1.,20),verbose=0,plot=True):
    """
